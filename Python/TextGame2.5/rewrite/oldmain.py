...
#attack, health, currenthealth attributes set to default values at the start of a new game
def intro():
    global attack
    global health
...
def youwon():
    print "\nYou win! Congratulations and thanks for playing Text Game 2.5! It was great fun to make.\n"
    menu()
