#main.py - the main file, initiates the game
import endings

menutext = "\n=========================\nT E X T  -  G A M E  -  2\n=========================\n\nHello, and welcome to Text Game 2!\n"
#looped: Used for the magic loop in the gym place
looped = 0
#battlestarted: Used to display battle initiation text with Snorlax
battlestarted = 0
snorhealth = 200
...
#default area text - use this when making a new area, to help keep from forgetting
#    adding certain actions and such
...
#setcharname() - Used to set the name of the main character - automatically called
#                at the beginning of a new game and can be used later to change name
def setcharname():
    global charname
...
#status - prints out the players name, other statistics for their information
def status():
    print "Name:           ", charname
...
#intro - attack, health, currenthealth attributes set to default values at the start of a new game, then starts the game.
def intro():
    global attack
    global health
    ...
    print "Welcome to Text Game 2! This should be a short, but hopefully interesting and...maybe?...memorable adventure.\n"
...
#attacksequence() - The actions to be executed during the battle scene thing
def attacksequence():
    global attack
    global health
    global currenthealth
...
#inputprompt() - Used as a generic input prompt - should be called everytime the
#                game needs input from the player
def inputprompt():
    global playerinput
...
#help() - Displays a list of commands and (maybe) other helpful information
def help():
    print "\n\n=============\nH   E   L   P\n=============\n"
    print "Command List:\n-------------"
