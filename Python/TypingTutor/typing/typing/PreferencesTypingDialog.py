...
from typing.helpers import get_builder

import gettext
from gettext import gettext as _
gettext.textdomain('typing')

class PreferencesTypingDialog(gtk.Dialog):
    __gtype_name__ = "PreferencesTypingDialog"
    preferences = {}
    ...
    def __new__(cls):
        ...
        Returns a fully instantiated PreferencesTypingDialog object.
        """
        builder = get_builder('PreferencesTypingDialog')
        new_object = builder.get_object("preferences_typing_dialog")
    ...
    def finish_initializing(self, builder):
        ...
        and creating a PreferencesTypingDialog object with it in order to
        finish initializing the start of the new PerferencesTypingDialog
        instance.
...
if __name__ == "__main__":
    dialog = PreferencesTypingDialog()
    dialog.show()
    gtk.main()
